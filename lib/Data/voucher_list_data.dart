...
List<Voucher> initialVouchers = [
  ...
  Voucher(
    ...
    minOrderValue: 1000000, // Đơn hàng tối thiểu 1tr mới được sử dụng
    maxUses: 100,
    currentUses: 0,
    startDate: DateTime(2023, 05, 1, 00, 00, 00), // Ngày bắt đầu là 01/05/2023 0:0:0
    expiryDate: DateTime(2024, 10, 31, 23, 59, 59), // Ngày hết hạn là 31/10/2024 23:59:59
  ...
  Voucher(
    id: '10',
    voucherName: 'HAPPY',
    displayName: 'Nhập mã "HAPPY" giảm 9% trên đơn hàng',
    discountPercentage: 9,
    maxDiscount: 100000,  // Tối đa giảm
    minOrderValue: 0, // Đơn hàng tối thiểu 40k mới được sử dụng
    maxUses: 100,
    currentUses: 0,
    startDate: DateTime(2023, 05, 1, 00, 00, 00), // Ngày bắt đầu là 01/05/2023 0:0:0
    expiryDate: DateTime(2024, 10, 31, 23, 59, 59), // Ngày hết hạn là 31/10/2024 23:59:59
